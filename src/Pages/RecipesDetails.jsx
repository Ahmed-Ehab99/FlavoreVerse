...
import { getDetRecipes, getAllRecipes } from "../Components/API"
...
export default function RecipesDetails() {
  ...
  const getRecipe = async (id) => {
    try {
      setLoading(true)
      const data  = await getDetRecipes(id)
      setRecipe(data)
      const recommend = await getAllRecipes({ query: recipe?.label, limit: 5 })
  ...
  return (
    <div className='w-full'>
      <TopSection title={recipe?.label} image={recipe?.image} />
